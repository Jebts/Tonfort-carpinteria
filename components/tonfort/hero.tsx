  ...
  return (
    <section id="top" ref={ref} className="relative min-h-[100svh] w-full overflow-hidden">
      ...
      <motion.div
        ...
        className="relative z-10 mx-auto flex h-full max-w-7xl flex-col justify-end px-6 pb-24 pt-28 sm:px-8 sm:pt-32 lg:px-10 lg:pb-28 lg:pt-36 xl:pt-40"
      >
        <motion.p
        ...
        <motion.h1
          ...
          className="max-w-[min(100%,52rem)] text-balance font-display font-bold text-white text-[clamp(1.875rem,5vw,5rem)] leading-[1.03] tracking-[-0.02em]"
        >
