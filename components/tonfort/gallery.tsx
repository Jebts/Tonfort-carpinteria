    ...
    <section id="experiencia" className="bg-background py-24 lg:py-32">
      <div className="mx-auto max-w-7xl px-6 lg:px-10">
        <div className="flex flex-col justify-between gap-6 md:flex-row md:items-end">
          <div>
            <p className="eyebrow mb-6 text-muted-foreground">Experiencia</p>
            <h2 className="display-lg max-w-2xl text-balance font-display text-foreground">
              No vendemos muebles. Vendemos la experiencia de un lugar.
            </h2>
            <p className="mt-6 max-w-xl text-pretty leading-relaxed text-muted-foreground">
              Cada proyecto empieza con una conversación y termina con la luz encendida.
              Mira cómo transformamos espacios reales y lleva la idea a tu propia casa.
            </p>
          </div>
          <a
            href="/proyectos"
