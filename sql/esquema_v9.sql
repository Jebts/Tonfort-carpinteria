...
--   1. Reemplaza 'tu_password_seguro_router' y 'tu_password_seguro_tenant'
--      por contraseñas fuertes generadas (p.ej. openssl rand -base64 32).
--   2. Ajusta (100000, 50000) en parametros_tokens y (0.00, 'COP') en
--      parametros_precios a los valores reales del negocio.
--   3. PARTICIONES de `mensajes`: este script crea 2026-07 .. 2026-10.
--      Hoy es 2026-07-07 (dentro de 2026-07). Si ejecutas fuera de ese
--      rango, añade CREATE TABLE mensajes_YYYY_MM PARTITION OF ... antes,
--      o los INSERTs de mensajes fallarán.
-- ============================================================
